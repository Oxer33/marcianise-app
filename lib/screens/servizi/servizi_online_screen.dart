      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Lista servizi online
            _buildServizioOnlineCard(
              'Certificati Online',
              'Richiedi certificati anagrafici, stato civile e altro.',
              Icons.description_rounded,
              AppColors.primary,
            ),
            _buildServizioOnlineCard(
              'Pagamenti Online',
              'Paga tributi, multe e servizi comunali.',
              Icons.payment_rounded,
              const Color(0xFF43A047),
            ),
            _buildServizioOnlineCard(
              'Pratiche Edilizie',
              'Presenta pratiche edilizie e urbanistiche.',
              Icons.apartment_rounded,
              const Color(0xFFE65100),
            ),
            _buildServizioOnlineCard(
              'Iscrizioni Scolastiche',
              'Iscrivi i tuoi figli alle scuole comunali.',
              Icons.school_rounded,
              const Color(0xFF6A1B9A),
            ),
            _buildServizioOnlineCard(
              'Albo Pretorio',
              'Consulta gli atti pubblicati all\'albo pretorio.',
              Icons.gavel_rounded,
              const Color(0xFF00838F),
            ),
            _buildServizioOnlineCard(
              'SPID / CIE',
              'Accedi ai servizi con SPID o Carta d\'Identità Elettronica.',
